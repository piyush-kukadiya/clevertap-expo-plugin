...
### [Version 2.0.0](https://github.com/CleverTap/clevertap-expo-plugin/releases/tag/2.0.0) (June 19, 2026)

#### Added
- Adds support for CleverTap React Native SDK [4.1.0](https://github.com/CleverTap/clevertap-react-native/blob/master/CHANGELOG.md#version-410-april-30-2026)

#### Android Platform ####
  - **Breaking:** Raises minimum supported Android API level from 21 to 23 (Android 6.0), required by CleverTap Android SDK [8.1.0](https://github.com/CleverTap/clevertap-android-sdk/blob/master/docs/CTCORECHANGELOG.md#version-810-april-17-2026). Host apps must ensure their `minSdkVersion` is at least 23.
  - Bumps CleverTap Android SDK to 8.1.0 and push-templates SDK to 2.4.0.
